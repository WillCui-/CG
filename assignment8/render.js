...
const configurePositionBufferRead = (gl, buffers, parameters) => {
    ...
    gl.vertexAttribPointer(parameters.attribLocations.vertexPosition, 3, gl.FLOAT, false, 0, 0);
...
const configureColorBufferRead = (gl, buffers, parameters) =>   {
    ...
    gl.vertexAttribPointer(parameters.attribLocations.vertexColor, numComponents, type, normalize, stride, offset);
...
const configureTextureBufferRead = (gl, buffers, parameters) => {
    ...
    gl.vertexAttribPointer(parameters.attribLocations.textureCoord, num, type, normalize, stride, offset);
